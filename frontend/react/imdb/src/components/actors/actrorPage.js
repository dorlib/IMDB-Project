...
`;
    ...
    const {loading, error, data} = useQuery(ACTOR_DATA,
        {
            variables: {
                id: lastSegment || 0
            }
    ...
    let name = data["actorById"]["0"]["name"]
    let profileImage = data["actorById"]["0"]["profileImage"] || 'https://hope.be/wp-content/uploads/2015/05/no-user-image.gif'
    let description = data["actorById"]["0"]["description"]
    let bornAt = data["actorById"]["0"]["bornAt"]
