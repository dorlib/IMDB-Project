...
//		GroupBy(favorite.FieldMovieTitle).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
func (fq *FavoriteQuery) GroupBy(field string, fields ...string) *FavoriteGroupBy {
	grbuild := &FavoriteGroupBy{config: fq.config}
...
//
//	client.Favorite.Query().
//		Select(favorite.FieldMovieTitle).
//		Scan(ctx, &v)
func (fq *FavoriteQuery) Select(fields ...string) *FavoriteSelect {
	fq.fields = append(fq.fields, fields...)
	selbuild := &FavoriteSelect{FavoriteQuery: fq}
	selbuild.label = favorite.Label
...
func (fgb *FavoriteGroupBy) sqlScan(ctx context.Context, v any) error {
...
func (fs *FavoriteSelect) sqlScan(ctx context.Context, v any) error {
	rows := &sql.Rows{}
